...
define openvpn::client(
  ...
  Integer $port                      = 1194,
  String $proto                      = 'tcp',
  Variant[String,Array] $remote_host = $::fqdn,
  String $resolv_retry               = 'infinite',
  String $auth_retry                 = 'none',
  Integer $verb                      = 3,
  Boolean $pam                       = false,
  Optional[String] $cipher           = 'AES-256-CBC',
  Optional[String] $tls_cipher       = 'TLS-DHE-RSA-WITH-AES-256-GCM-SHA384:TLS-DHE-RSA-WITH-AES-256-CBC-SHA256:TLS-DHE-RSA-WITH-AES-128-GCM-SHA256:TLS-DHE-RSA-WITH-AES-128-CBC-SHA256',
